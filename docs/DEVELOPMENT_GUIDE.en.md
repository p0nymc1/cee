...
> 中文版：[DEVELOPMENT_GUIDE.md](DEVELOPMENT_GUIDE.md)

For people who are going to develop *on* this codebase — whether modifying the engine itself or plugging in a new
domain plugin. Architecture rationale is in [`TECHNICAL_SPECIFICATION.en.md`](TECHNICAL_SPECIFICATION.en.md);
contribution rules are in [`NORMATIVE_HANDBOOK.en.md`](NORMATIVE_HANDBOOK.en.md). This document only covers how to get
your hands on it.
