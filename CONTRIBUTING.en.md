...
mandatory red lines are in [`docs/NORMATIVE_HANDBOOK.en.md`](docs/NORMATIVE_HANDBOOK.en.md), and the hands-on detail is
in [`docs/DEVELOPMENT_GUIDE.en.md`](docs/DEVELOPMENT_GUIDE.en.md).
...
[`docs/NORMATIVE_HANDBOOK.en.md`](docs/NORMATIVE_HANDBOOK.en.md). **Violation means the merge is rejected.** In
summary:
