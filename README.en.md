...
written by hand. The site has three parts:

| Page | What's on it |
|---|---|
| [Evidence](https://p0nymc1.github.io/cee/) | Full execution output for every scenario, all captured rather than written |
| [Leaderboard](https://p0nymc1.github.io/cee/leaderboard/) | Plugins ranked by `cee bench`, with how it is measured and what the number is not |
| [Blog](https://p0nymc1.github.io/cee/blog/) | Design decisions, including the ones that turned out wrong |

The site is generated by `.github/site` (a separate module, kept out of the core) and reproducible locally with
`make site`.
...
| `make site` | Build the published site into `./site` (runs the examples, then renders evidence, leaderboard and blog) |
